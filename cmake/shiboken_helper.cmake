...
if(Shiboken6_FOUND)
  message("Found Shiboken6 version ${Shiboken6_VERSION}")
  if(NOT ${Shiboken6_VERSION} VERSION_LESS "5.13")
    ...
    set(SHIBOKEN_BINARY shiboken6)
  endif()
  message("Using SHIBOKEN_INCLUDE_DIR: ${SHIBOKEN_INCLUDE_DIR}")
  message("Using SHIBOKEN_LIBRARY: ${SHIBOKEN_LIBRARY}")
  message("Using SHIBOKEN_BINARY: ${SHIBOKEN_BINARY}")
endif()

find_package(PySide6 QUIET)
if(PySide6_FOUND)
  message("Found PySide6 version ${PySide6_VERSION}")
  if(NOT ${PySide6_VERSION} VERSION_LESS "5.13")
...
if(Shiboken6_FOUND AND PySide6_FOUND)
  ...
  message("Shiboken binding generator NOT available.")
